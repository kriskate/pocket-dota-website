      ...
      <MDBContainer className="padtop">
        ...
        <MDBRow>
          <p>
            <h2>Contact</h2>
            <p>
              <p className="mb-4 hoverer">If you have any questions or suggestions about <AppName />, do not hesitate to contact me via email @ <a href='mailto:pocket.dota.app@gmail.com' target='_blank' rel="noopener noreferrer">pocket.dota.app@gmail.com</a>.</p>
